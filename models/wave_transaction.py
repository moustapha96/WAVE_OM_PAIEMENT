...
#                 .ccbm-branding {{ color: #007bff; font-weight: bold; }}
#             </style>
#         </head>
#         <body>
#             <div class="header">
#                 <h1 class="ccbm-branding">FACTURE DE PAIEMENT WAVE</h1>
#                 <h2>Référence: {self.reference}</h2>
#             </div>
...
#                     <p><strong>Email:</strong> {company.email or 'contact@ccbmshop.sn'}</p>
#                     <p><strong>Site Web:</strong> www.ccbmshop.sn</p>
#                 </div>
#                 <div class="company-logo">
#                     <img src="https://ccbmshop.sn/logo.png" alt="CCBM Shop Logo" onerror="this.style.display='none'"/>
#                 </div>
#             </div>
...
#             <div class="footer">
#                 <p><strong class="ccbm-branding">CCBM SHOP</strong> - Votre partenaire technologique de confiance</p>
#                 <p>Cette facture a été générée automatiquement le {datetime.now().strftime('%d/%m/%Y à %H:%M:%S')}</p>
#                 <p>Merci pour votre paiement via Wave Money</p>
...
#                     'facture_url': self.url_facture,
#                     'company_name': 'CCBM SHOP'
#                 }
                
#                 # Créer le message email
#                 mail_values = {
#                     'subject': f'Facture Wave - {self.reference}',
#                     'body_html': f"""
...
#                     'email_from': self.env.company.email or 'noreply@ccbmshop.sn',
#                 }
...
#                 _logger.info(f"Notification email envoyée à {self.partner_id.email}")
